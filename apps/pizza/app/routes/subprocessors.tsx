  ...
  return (
    <main className="mx-auto w-full max-w-[550px] px-4 pt-20 pb-24 antialiased [&_a]:underline [&_a]:decoration-border [&_a]:underline-offset-4 [&_a:hover]:text-foreground">
      ...
      <p className="mt-2 text-sm leading-6 text-muted-foreground">
        Updated September 23, 2026. These services process personal information
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm leading-6 text-muted-foreground">
          Hosts the app, pools database connections, and provides network security and diagnostics.
      ...
      <section className="mt-10 space-y-3">
        <h2 className="text-sm font-semibold">PlanetScale</h2>
        <p className="text-sm leading-6 text-muted-foreground">
          Hosts our application database in AWS Oregon. Stores account identifiers,
          names, email addresses, authorization tokens, booking records, and
          booking-code access records as our database infrastructure provider.
        </p>
        <p className="text-sm leading-6 text-muted-foreground">
          <a href="https://planetscale.com/legal/privacy">PlanetScale privacy policy</a>
        </p>
      </section>
      <section className="mt-10 space-y-3">
